package ussaid.iqbal.transactcampus.utils;
...
public class TinyDB {
    ...
    public ArrayList<ImagesModel> getListObject(String key){
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<ImagesModel> objects =  new ArrayList<ImagesModel>();
    	for(String jObjString : objStrings){
            ImagesModel value  = gson.fromJson(jObjString,  ImagesModel.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<ImagesModel> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
